...
ALTER TABLE `files`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `user_id` (`user_id`,`name`,`parent_id`),
  ADD KEY `parent_id` (`parent_id`),
  ADD KEY `uploaded_by_device_id` (`uploaded_by_device_id`),
...
ALTER TABLE `files`
  ...
  ADD CONSTRAINT `files_ibfk_3` FOREIGN KEY (`parent_id`) REFERENCES `files` (`id`),
  ADD CONSTRAINT `files_ibfk_4` FOREIGN KEY (`blob_id`) REFERENCES `blobs` (`id`) ON DELETE CASCADE;
